export default function PrivacyPolicy() {
  return (
    <section className="mt-[100px] p-8">
      ...
      <h2 className="text-lg text-blue-blue-950 font-bold my-2">
        Interpretation
      </h2>
      ...
      <ul className="my-4 list-disc list-inside">
        ...
        <li>
          <strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Interior Mebel, Almaty, Kazakhstan 050038.
        </li>
        <li>
        ...
        <li>
          <strong>Website</strong> refers to Interior Mebel, accessible from <a href="http://interiormebel.me" rel="external nofollow noopener" target="_blank">http://interiormebel.me</a>
        </li>
        <li>
      ...
      <ul className="my-4">
        <li>By email: interior-mebel@proton.me</li>
      </ul>
    </section>
  )
}