  ...
  return (
    ...
    <section className='flex flex-wrap margin'>
      <div className="flex-1 order-0 discount-section">
        <h1 className='font-bold text-6xl m-3 '>Find your</h1>
        ...
        <div className='bg-discount'>
          <Image src={discount} alt='discount'className='flex flex-col'/>
          <span className='span1'>Upto</span>
          <span className='span2'>20%</span>
          <span className='span3'>OFF</span>
        </div>
        <button className='btn-primary font-medium text-white px-4 mt-9 rounded-md py-3 w-1/3'>Buy Now</button>
      </div>
