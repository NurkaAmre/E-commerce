...
export default function MainSection (){
  return (
    <>
      <div className="grid md:mb-[5rem] grid-cols-1 w-4/5 mx-auto font-[cormorant] mt-[180px] md:grid-cols-2">
        ...
        <div className="bg-[#d2c6b1] py-20 md:h-auto flex items-center">
