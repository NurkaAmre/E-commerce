...
export default function MainSection (){
  return (
    <>
      <div className="grid grid-cols-1 w-4/5 mx-auto font-cormorant mt-[150px] md:grid-cols-2">
        <div className="flex flex-col items-center text-center pb-4 md:py-12 bg-[#788A74]">
          <div className='heading mt-8'>
            <h2 className='text-4xl text-white leading-9'><span className='highLight text-5xl md:text-7xl'>М</span>ебельный магазин</h2>
            <h2 className='text-4xl text-white leading-8'><span className='highLight  md:text-7xl text-5xl'>И</span>нтерьер</h2>
          </div>
          ...
          <button className='btn-primary btn align-middle font-medium text-white px-10  rounded-full'>Заказать</button>
        </div>
