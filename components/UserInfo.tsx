      ...
      <div className='flex flex-col md:flex-row gap-10 md:justify-evenly'>
        ...
        <div className='flex flex-col relative w-[250px]'>
          ...
          <div className='flex flex-col my-3 text-gray-700'>
            ...
            <span className='user-input text-base font-roboto'>{name}</span>
          </div>
        </div>
        ...
        <div className='flex flex-col relative w-[250px]'>
          ...
          <div className='flex flex-col my-3  text-gray-700'>
            ...
            {!contactInfoEditMode ? <span className='user-input text-base font-roboto'>{user.phone}</span>
          ...
          <div className='flex flex-col my-3'>
            ...
            {!contactInfoEditMode ? <span className='user-input text-base font-roboto'>{user.email}</span>
        ...
        <div className='flex flex-col relative w-[250px]'>
          ...
          <div className='flex flex-col my-3'>
            ...
            {!addressEditMode ? <span className='user-input text-base font-roboto'>{user.address?.street}</span>
          ...
          <div className='flex flex-col my-3 text-gray-700'>
            ...
            {!addressEditMode ? <span className='user-input text-base font-roboto'>{user.address?.city}</span>
          ...
          <div className='flex flex-col my-3'>
            ...
            {!addressEditMode ? <span className='user-input text-base font-roboto'>{user.address?.zip}</span>
